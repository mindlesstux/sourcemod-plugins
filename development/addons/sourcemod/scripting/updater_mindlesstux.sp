/****************************************
 *
 * Taken from Dr. Mckay, and modifed as requested
 * Added branch settings, so can have stable relase and development versions (useful for testing)
 *
 * mckayupdater.sp
 * https://bitbucket.org/Doctor_McKay/public-plugins/raw/d92573285b1821a916d7c8bb1aafa1ebab3bb45a/scripting/mckayupdater.sp
 *
...
#define UPDATER_BASE_URL "http://mindlesstux.com/sourcemod-plugins-release"
